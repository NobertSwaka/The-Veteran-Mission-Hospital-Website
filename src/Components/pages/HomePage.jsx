  ...
  <div className="absolute inset-0 flex items-center justify-center text-white z-10 text-center p-4"> {/* Centered content */} 
    <div>
      ...
      {/* <p className="text-lg md:text-2xl mb-6">
        Caring for you and your family with compassion and expertise.
      </p> */}
      <br />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            ...
            <img
              ...
              <div className="flex justify-center mt-4">
                <Link
                  to="/EmergencyCare" // Replace with the actual path
            ...
            <img
              ...
              <div className="flex justify-center mt-4">
                <Link
                  to="/CardiologyClinic" // Replace with the actual path
                  className="inline-block bg-green-600 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded text-center"
                >
                  Read More
                </Link>

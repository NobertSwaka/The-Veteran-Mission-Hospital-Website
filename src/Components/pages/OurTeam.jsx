...
import teamMember4 from '../pages/Images/member4.jpeg';
  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      ...
      <section
        ...
        style={{
          backgroundImage:
            "url('https://i.pinimg.com/564x/c5/1a/f9/c51af9c54384f79166751cfe24abc79c.jpg')",
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center text-white">
          ...
          <p className="text-lg mt-4">Dedicated Professionals Committed to Exceptional Care</p>
        </div>
      </section>
      ...
      <div className="py-16">
        ...
        {teamSections.map((section, sectionIndex) => (
          <div key={sectionIndex} className="mb-12">
            <h3 className="text-2xl font-semibold text-center mb-8">{section.title}</h3>
